                ...
                <div class="tab-pane active" id="tab_default_1">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ms-panel">
                                <div class="ms-panel-header d-flex justify-content-between">
                                    <button class="btn btn-dark" data-toggle="modal" data-target="#add-Annoucement-Gallery">add Annoucement Gallery </button>
                                </div>
                                <div class="ms-panel-body">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#" onclick="destroy('this Announcement','{{$gallery->id}}')" class="btn d-inline-block btn-danger">delete</a>
                ...
                <div class="tab-pane" id="tab_default_2">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ms-panel">
                                <div class="ms-panel-header d-flex justify-content-between">
                                    <button class="btn btn-dark" data-toggle="modal" data-target="#add-Announce-Files"> add Announce Files</button>
                                </div>
                                <div class="ms-panel-body">
                            ...
                            <div class="ms-auth-container row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select data-size="7" name="related_announce_id" data-live-search="true" class="selectpicker  fill_selectbtn_in own_selectbox" data-title="course" id="state_list" data-width="100%">
