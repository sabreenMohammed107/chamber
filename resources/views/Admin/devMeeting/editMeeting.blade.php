            ...
            <div class="ms-panel-body">
                <div class="ms-auth-container row no-gutters">
                    <div class="col-12 p-3">
                        <form action="{{route('devMeeting.update',$row->id)}}" method="POST">
                            ...
                            <div class="ms-auth-container row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example2">ar_schedule</label>
                                        <div class="form-group">
                                            <textarea class="content" name="ar_schedule">{{$row->ar_schedule}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example2">en_schedule</label>
                                        <div class="form-group">
                                            <textarea class="content" name="en_schedule">{{$row->en_schedule}}</textarea>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="tab-pane active" id="tab_default_1">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ms-panel">
                                <div class="ms-panel-header d-flex justify-content-between">
                                    <button class="btn btn-dark" data-toggle="modal" data-target="#add-Annoucement-Gallery">add Page Gallery</button>
                                </div>
                                <div class="ms-panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="courseEval" class="dattable table table-striped thead-dark  w-100">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$index+1}}</td>
                                                    <td><img src="{{ asset('uploads/meeting')}}/{{ $gallery->image }}" alt=""></td>
                                                    <td class="sorting_1">
                                                    ...
                                                    <td>
                                                        ...
                                                        <form id="delete_{{$gallery->id}}" action="{{ route('deleteMeetingGallery', $gallery->id) }}" method="POST" style="display: none;">
                                                            @csrf
                                                    ...
                                                    <div class="modal-dialog modal-lg " role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="ms-auth-container row no-gutters">
                                                                    <div class="col-12 p-3">
                                                                        <form action="{{route('updateMeetingGallery')}}" method="POST" enctype="multipart/form-data">
                                                                            {{ csrf_field() }}


                                                                            <input type="hidden" name="department_meeting_id" value="{{$row->id}}">
                                                                            <input type="hidden" name="gallery_id" value="{{$gallery->id}}">
                                                                            <div class="ms-auth-container row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <div class="img-upload">
                                                                                            <img src="{{ asset('uploads/meeting')}}/{{ $gallery->image }}" alt="">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form id="delete_{{$file->id}}" action="{{ route('deleteMeetingFile', $file->id) }}" method="POST" style="display: none;">
                                                            @csrf
                                                    ...
                                                    <div class="modal-dialog modal-lg " role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="ms-auth-container row no-gutters">
                                                                    <div class="col-12 p-3">
                                                                        <form action="{{route('updateMeetingFile')}}" method="POST" enctype="multipart/form-data">
                                                                            @csrf
                                                                            <input type="hidden" name="department_meeting_id" value="{{$row->id}}">
                    ...
                    <div class="modal-dialog modal-lg " role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="ms-auth-container row no-gutters">
                                    <div class="col-12 p-3">
                                        <form action="{{route('addMeetingGallery')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="department_meeting_id" value="{{$row->id}}">
                                            <div class="ms-auth-container row">
                                                <div class="col-md-12">
                    ...
                    <div class="modal-dialog modal-lg " role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="ms-auth-container row no-gutters">
                                    <div class="col-12 p-3">
                                        <form action="{{route('addMeetingFile')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="department_meeting_id" value="{{$row->id}}">
