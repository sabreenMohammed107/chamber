    ...
    <div class="col-md-12">
        ...
        <div class="ms-panel">
            <div class="ms-panel-header d-flex justify-content-between">
                <h6>Ministries</h6>
                <a href="{{route('ministries.create') }}" class="btn btn-dark"> add Ministries</a>
            </div>
                    ...
                    <table id="courseEval" class="dattable table table-striped thead-dark  w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('ministries.edit',$row->id) }}" class="btn btn-info d-inline-block">edit</a>
                                    <a href="#" onclick="destroy('this ministries','{{$row->id}}')" class="btn d-inline-block btn-danger">delete</a>
