...
<ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"> دراسة / تقرير </li>
    </ol>
</nav>
            ...
            <div class="ms-panel-body">
                <div class="ms-auth-container row no-gutters">
                    <div class="col-12 p-3">
                        ...
                        <form action="{{route('study-report.update',$row->id)}}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="ms-auth-container row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> النوع </label>
                                        <select name="study_type_id" class="form-control" id="">
                                            <option value="">
                                                @if($row->type)
                                                {{$row->type->ar_type}}
                                                @endif
                                ...
                                <div class="input-group d-flex justify-content-end text-center">
                                    <a href="{{ route('study-report.index') }}" class="btn btn-dark mx-2"> إلغاء</a>
