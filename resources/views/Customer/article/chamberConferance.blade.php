        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate text-center mb-4">
                    <h1 class="mb-2 bread">{{ __('links.conferenceRoom') }}</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        ...
        <div class="col-md-7 ftco-animate text-justify img-thumbnail p-4">
                    <div class="heading-section mb-4 my-5 my-md-0">
                        <h2 class="mb-4 text-decoration">{{ __('links.conferenceRoom') }}</h2>
                    </div>
                    @if(app()->getLocale()=='en')
                {!!$data->en_text!!}
                @else
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item {{$key == 0 ? 'active' : '' }}">
                            ...
                            <a class="col-md-3 text-center various fancybox fancy.iframe" data-fancybox-type="iframe" href="{{$gallery->vedio}}">
                                <img src="{{ asset('uploads/article/'.$gallery->image) }}" alt="img-1" style="height: 200px !important" class="img-fluid"></a>
                            <div class="overlay"></div>
                            @else
