      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            <h1 class="mb-2 bread">موضوعات تجارية</h1>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-3 mb-3 ml-3">
              ...
              <select name="topic_id" id="topic_id" class="browser-default custom-select" >
...
<div id="regionDetails">
    @include('Customer.encyclo.commerical-topicDetails')
