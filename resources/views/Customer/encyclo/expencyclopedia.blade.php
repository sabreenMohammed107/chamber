      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            <h1 class="mb-2 bread">موسوعة المصدرين</h1>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-3 mb-3 ml-3">
              ...
              <select name="exporter_id" id="exporter_id" class="browser-default custom-select" >
...
<div id="regionDetails">
    @include('Customer.encyclo.encyclopediaDetails')
...
@section('scripts')
<script>
    $(document).on('change', '#exporter_id', function (e) {
...
$.ajax({
    ...
    url : "{{ URL::to('fetch_expencyclopedia') }}",
    data :
     {
        exporter_id :$('#exporter_id').val()
         },
