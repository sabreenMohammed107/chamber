      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            <h1 class="mb-2 bread">وزارات و هيئات حكومية</h1>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-3 mb-3 ml-3">
              ...
              <select name="ministry_id" id="ministry_id" class="browser-default custom-select" >
...
<div id="regionDetails">
    @include('Customer.encyclo.ministryDetails')
...
@section('scripts')
<script>
    $(document).on('change', '#ministry_id', function (e) {
