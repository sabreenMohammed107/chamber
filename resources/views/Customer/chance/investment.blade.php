    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 ftco-animate">
          ...
          <div id="investmentContent" class="table-responsive">
              @include('Customer.chance.investmentList')
...
//pagination
$(document).on('click', '#categoryinvestment .pagination a', function(event){
